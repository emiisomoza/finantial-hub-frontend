...
![CI](https://github.com/emiisomoza/finantial-hub-frontend/actions/workflows/ci.yml/badge.svg)
...
### Prerequisites
- Node.js 20+
- The [Financial Profile API](https://github.com/emiisomoza/finantial-profile-api) running at `http://localhost:8080`

### Setup
```bash
git clone https://github.com/emiisomoza/finantial-hub-frontend.git
cd finantial-hub-frontend
npm install
```
